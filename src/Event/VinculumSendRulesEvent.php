...
/**
 * Event that is fired when a vinculum needs to be send (rules event).
 *
 * @see rules_vinculum_send()
 */
class VinculumSendRulesEvent extends Event {

  const EVENT_NAME = 'rules_vinculum_send';
